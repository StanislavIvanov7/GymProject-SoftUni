...
namespace Gym.Infrastructure.Migrations
{
    ...
    [Migration("20240404130548_CreateBuyerProductMappingTable")]
    partial class CreateBuyerProductMappingTable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Gym.Infrastructure.Data.Models.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("Gym.Infrastructure.Data.Models.BuyerFitnessCard", b =>
                {
                    ...
                    b.HasKey("FitnessCardId", "BuyerId");

                    b.HasIndex("BuyerId");

                    b.ToTable("BuyersFitnessCards");

                    b.HasComment("Buyer Fitness Card Mapping Table");
                });

            modelBuilder.Entity("Gym.Infrastructure.Data.Models.BuyerProduct", b =>
                {
                    ...
                    b.HasComment("Buyer Product Mapping Table");
                });
            ...
            modelBuilder.Entity("Gym.Infrastructure.Data.Models.FitnessCard", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IssuesDate = new DateTime(2024, 4, 4, 16, 5, 48, 340, DateTimeKind.Local).AddTicks(3350),
            ...
            modelBuilder.Entity("Gym.Infrastructure.Data.Models.BuyerFitnessCard", b =>
                {
                    b.HasOne("Gym.Infrastructure.Data.Models.ApplicationUser", "Buyer")
                        .WithMany()
            ...
            modelBuilder.Entity("Gym.Infrastructure.Data.Models.Diet", b =>
                {
                    b.HasOne("Gym.Infrastructure.Data.Models.ApplicationUser", "Creator")
                        .WithMany()
            ...
            modelBuilder.Entity("Gym.Infrastructure.Data.Models.UserFitnessCard", b =>
                {
                    ...
                    b.HasOne("Gym.Infrastructure.Data.Models.ApplicationUser", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Gym.Infrastructure.Data.Models.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Gym.Infrastructure.Data.Models.FitnessCard", b =>
                {
                    b.Navigation("BuyerFitnessCards");
